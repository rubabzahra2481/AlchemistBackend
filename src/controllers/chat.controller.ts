    ...
    try {
      ...
      trace.steps.push({
        ...
        data: {
          ...
          frameworksTriggered: Object.keys(response.profile || {}).filter(k => 
            !['safety', 'summaryForThisMessage', 'integrationMeta'].includes(k) && response.profile[k]
          ),
        },
      ...
      // Fetch conversation history to show in debug
